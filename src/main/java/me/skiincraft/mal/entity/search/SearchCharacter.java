		...
		super(t -> {
			try {
				...
				for (Element e: elementos) {
					...
					t.add(new SearchResult(element.text(), getId("/character/", element.attr("href")), Objects.requireNonNull(ExtractElements.extractImage(e.selectFirst("img").attr("data-src"), ExtractElements.CHARACTER))));
				}
